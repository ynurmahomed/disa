...
public class  DisaServiceTest extends BaseModuleContextSensitiveTest {
	...
	public void fsrEncounterShouldNotBeNull() throws ParseException {
		...
		encounter.setProvider(encounterService.getEncounterRoleByUuid("a0b03050-c99b-11e0-9572-0800200c9a66"), providerService.getProviderByUuid("e2bc3932-1d5f-11e0-b929-000c29ad1d07"));
		
		Obs obs = new Obs();
		obs.setPerson(personService.getPersonByUuid("e2bc3932-1d5f-11e0-b929-000c29ad1d07"));
